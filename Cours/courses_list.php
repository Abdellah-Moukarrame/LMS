...
<?php 
        ...
        $resultat = $connectiondb->query($data);
    ...
    <div class="w-full max-w-4xl bg-white/20 backdrop-blur-lg shadow-2xl rounded-2xl p-10 border border-white/30">
        ...
        <div class="flex items-center justify-between mb-8">
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-3xl font-extrabold text-white drop-shadow">Liste des cours</h1>
            </div>
                    ...
                    ?>
                        ...
                        <td class="p-4 flex gap-3">
                            ...
                            <a href="courses_edit.php"
                               class="px-4 py-2 rounded-lg text-white bg-white/20 border border-white/30 
                            ...
                            <a href="courses_delete.php"
                               class="px-4 py-2 rounded-lg text-white bg-red-500/40 border border-red-300/40 
                                      hover:bg-red-500/60 transition">
                                Supprimer
                            </a>
